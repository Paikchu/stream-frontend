...
export default function SignUp(props) {
    ...
    function getJSONPayload() {
        if (props.name === "man")
            return JSON.stringify({m_name: name, m_email: email, m_pwd: password})
        else if (props.name === "com")
            return JSON.stringify({com_name: name, com_email: email, com_pwd: password})
        else
            return JSON.stringify({u_name: name, u_email: email, u_pwd: password})
    }
